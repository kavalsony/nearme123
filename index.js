...
var appId = process.env.APP_ID || 'KsAar5JOk3IyvOkd9MQu';
var masterKey = process.env.MASTER_KEY || '8fxSvTDY7JKQSzGLVnNX';
var restApiKey = 'FZJXQCpBuVyrsOARDOPt';
var appName = 'nearme';

// Mailgun configuration
var apiKey = process.env.MAILGUN_API_KEY || 'key-278c861cbc5df2aa53514cf7415b0155';
var domain = process.env.MAILGUN_DOMAIN || 'sandbox35b0c3809ab94117a92f3e27b85ae1e3.mailgun.org';
var fromAddress = process.env.MAILGUN_FROM_ADDRESS || 'QuanLabs <dev@quanlabs.com>';

// AWS S3 configuration
var accessKeyId = process.env.AWS_ACCESS_KEY_ID || 'EV/H2gWphdxQz9K2az6UmlEvEBGismjq/IEJTGkE';
var secretAccessKey = process.env.AWS_SECRET_ACCESS_KEY || 'AKIAJUPB27EZX4CPBPHA';
var bucketName = process.env.BUCKET_NAME || 'wedwise';
